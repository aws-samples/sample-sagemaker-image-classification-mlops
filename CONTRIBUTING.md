...
Thank you for your interest in contributing to this project. Whether it is a bug
...
2. Modify the source; please focus on the specific change you are contributing.
   ...
   change.
3. Ensure local checks pass: `ruff check . && ruff format --check .`,
   `checkov -d .`, and `terraform validate` for any changed stack.
...
report it privately to the project maintainers rather than opening a public
issue.
