...
| `ops_generate_endpoint_traffic.py` | Send synthetic traffic to the endpoint (seed Model Monitor data)  |
...
| Script                          | Purpose                                                              |
| ------------------------------- | -------------------------------------------------------------------- |
| `ops_fix_monitor_baseline.py` | Upload a synthetic Model Monitor baseline (needed for base64 images) |
